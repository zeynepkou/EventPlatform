...
namespace Yazlab2.Migrations
{
    ...
    [Migration("20241129204350_ilgialani")]
    partial class ilgialani
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Yazlab2.Models.IlgiAlani", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Yazlab2.Models.KullaniciIlgiAlani", b =>
                {
                    b.Property<int>("KullanıcıID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("KullanıcıID", "IlgiAlaniID");
            ...
            modelBuilder.Entity("Yazlab2.Models.Etkinlik", b =>
                {
                    b.HasOne("Yazlab2.Models.Kategori", "Kategori")
                        .WithMany()
            ...
            modelBuilder.Entity("Yazlab2.Models.IlgiAlani", b =>
                {
                    b.HasOne("Yazlab2.Models.Kullanıcı", null)
                        .WithMany("IlgiAlanlari")
                        .HasForeignKey("KullanıcıID");
                });

            modelBuilder.Entity("Yazlab2.Models.Kategori", b =>
                {
                    b.HasOne("Yazlab2.Models.IlgiAlani", "IlgiAlani")
                        .WithMany("Kategoriler")
                        .HasForeignKey("IlgiAlaniID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
